        ...
        lessons: [
            {
                ...
                steps: [
                    ...
                    {
                        title: "Phần 2: Microsoft Account",
                        content: "<p>Từ đây, bạn có thể truy cập thông tin ** Microsoft Account **, View hồ sơ của bạn và chuyển đổi tài khoản.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 3: Tell Me",
                        content: "<p>Thanh ** Tell Me ** cho phép bạn tìm kiếm các lệnh, điều này đặc biệt hữu ích nếu bạn không nhớ tìm một lệnh cụ thể ở đâu.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 4: Nhóm lệnh",
                        content: "<p>Mỗi nhóm chứa một loạt ** lệnh ** khác nhau. Chỉ cần nhấp vào bất kỳ lệnh nào để áp dụng nó. Một số nhóm còn có ** mũi tên ** ở góc dưới bên phải mà bạn có thể nhấp vào để xem thêm lệnh.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 5: Quick Access Toolbar",
                        content: "<p>** Quick Access Toolbar ** cho phép bạn truy cập các lệnh phổ biến bất kể tab nào được chọn. Theo mặc định, nó bao gồm các lệnh ** Save <strong>, ** Undo ** và ** Redo </strong>.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 6: Ruler",
                        content: "<p>** Ruler ** nằm ở trên cùng và bên trái tài liệu của bạn. Nó giúp việc ** căn chỉnh ** và ** điều chỉnh khoảng cách ** trở nên dễ dàng hơn.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 7: Scroll Bar",
                        content: "<p>Nhấp và kéo ** dọc Scroll Bar ** để di chuyển lên và xuống qua các trang trong tài liệu của bạn.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 8: Zoom Control",
                        content: "<p>Nhấp và kéo thanh trượt để sử dụng Zoom Control. Số ở bên phải thanh trượt phản ánh ** phần trăm thu phóng **.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 9: Document Views",
                        content: "<p>Có ba cách để View một tài liệu:</p> <p>** Read Mode ** hiển thị tài liệu của bạn ở chế độ toàn màn hình.  ** Print Layout ** được chọn theo mặc định. Nó hiển thị tài liệu giống như trên trang in. ** Web Layout ** hiển thị cách tài liệu của bạn trông như một trang web.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 10: Ribbon",
                        content: "<p>** Ribbon ** chứa tất cả ** lệnh ** bạn sẽ cần để thực hiện các tác vụ phổ biến trong Word. Nó có nhiều ** tab **, mỗi tab có một số ** nhóm ** lệnh.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 11: ngăn tài liệu",
                        content: "<p>Đây là nơi bạn sẽ ** nhập và chỉnh sửa văn bản ** trong tài liệu.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 12: Số trang và số từ",
                        content: "<p>Từ đây, bạn có thể nhanh chóng xem số lượng ** từ ** và ** trang ** trong tài liệu của mình.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 13: Zoom Control",
                        content: "<p>Nhấp và kéo thanh trượt để sử dụng Zoom Control. Số ở bên phải thanh trượt phản ánh ** phần trăm thu phóng **.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 14: Làm việc với môi trường Word",
                        content: "<p>Tất cả các phiên bản Word gần đây đều bao gồm ** Ribbon ** và ** Quick Access Toolbar <strong>, nơi bạn sẽ tìm thấy các lệnh để thực hiện các tác vụ phổ biến trong Word, cũng như ** Backstage view </strong>.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 15: Ribbon",
                    ...
                    {
                        title: "Phần 16: Quick Access Toolbar",
                    ...
                    {
                        title: "Phần 19: Open",
                        content: "<p>Từ đây, bạn có thể ** Open tài liệu ** được lưu vào máy tính hoặc vào OneDrive của bạn.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 20: Save và Save As",
                        content: "<p>Bạn sẽ sử dụng ** Save ** và ** Save As ** cho tài liệu Save cho máy tính của bạn hoặc cho OneDrive.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 21: Print",
                        content: "<p>Từ khung Print, bạn có thể thay đổi cài đặt ** Print ** và Print tài liệu của mình. Bạn cũng có thể xem ** bản xem trước ** tài liệu của mình.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 22: Export",
                        content: "<p>Từ đây, bạn có thể Export tài liệu của mình ở định dạng File khác, chẳng hạn như ** PDF/XPS **.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 23: Close",
                        content: "<p>Nhấp vào đây để ** Close ** tài liệu hiện tại.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 24: Share",
                        content: "<p>Từ đây, bạn có thể mời mọi người ** View và cộng tác ** trên tài liệu của mình.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 25: Quay lại Word",
                        content: "<p>Bạn có thể sử dụng mũi tên để ** Close ** ** Backstage ** ** View ** và quay lại Word.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 26: Account",
                        content: "<p>Từ ngăn Account, bạn có thể truy cập thông tin ** Microsoft Account ** của mình, sửa đổi chủ đề và nền cũng như đăng xuất khỏi Account.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 27: Options",
                        content: "<p>Tại đây, bạn có thể thay đổi nhiều Word khác nhau ** Options **. Ví dụ: bạn có thể kiểm soát cài đặt kiểm tra chính tả và ngữ pháp, cài đặt Tự động Phục hồi và tùy chọn ngôn ngữ.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 28: Info",
                        content: "<p>** khung thông tin ** sẽ xuất hiện bất cứ khi nào bạn truy cập Backstage view. Nó chứa thông tin về tài liệu hiện tại. Bạn cũng có thể ** kiểm tra ** tài liệu để xóa Info cá nhân và ** bảo vệ ** tài liệu đó để ngăn người khác thực hiện thêm các thay đổi.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 29: New",
                        content: "<p>Từ đây, bạn có thể tạo ** New Blank document ** hoặc bạn có thể chọn từ một bộ sưu tập lớn ** mẫu **.</p>",
                        icon: "fa-list-ul"
                    },
                    {
                        title: "Phần 30: Document Views và thu phóng",
